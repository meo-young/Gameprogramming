...
public class PlayerMovementScript : MonoBehaviour {
	...
	void Awake(){
        ...
        originalScale = transform.localScale; // 플레이어의 원래 Scale 저장
	...
	*/
	void Crouching(){
        ...
        {
            transform.localScale = Vector3.Lerp(transform.localScale, new Vector3(originalScale.x, originalScale.y * 0.6f, originalScale.z), Time.deltaTime * 15);
        }
        else
        {
